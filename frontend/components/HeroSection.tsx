    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container text-center space-y-12">
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          <Badge className="mx-auto gap-2 bg-gradient-primary border-primary/20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" className="gap-2 bg-gradient-primary shadow-glow px-8 py-6 text-lg">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {[
            ...
            <Card key={index} className="p-6 bg-card/50 border-border/50 hover:shadow-glow transition-all duration-300 group">
          ...
          <Card className="p-8 bg-gradient-secondary border-border/50">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Average Model Accuracy</p>
              </div>
              <div>
                <div className="text-3xl font-bold text-accent">50+</div>
                <p className="text-muted-foreground">Pre-built Components</p>
              </div>
            </div>
          </Card>
        </div>

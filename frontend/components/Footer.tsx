        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/ParagGhatage/ZeroML" className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <a href="mailto:help@zeroml.dev" className="text-muted-foreground hover:text-primary transition-colors">

...
const Features = () => {
  return (
    <section id="features" className="py-24 bg-[#07121a]/40">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Powerful Features for
            <span className="bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent"> Modern ML</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-[#07121a]/60 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 hover:border-orange-500/50 transition-all duration-300 hover:transform hover:-translate-y-2"
            >
              ...
              <div className="w-0 h-0.5 bg-gradient-to-r from-orange-400 to-yellow-400 mt-6 group-hover:w-full transition-all duration-500"></div>
            </div>
          ))}
        </div>
      </div>
